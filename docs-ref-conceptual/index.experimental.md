...
layout: HubPage
hide_bc: true
title: Centro de desarrollo de Node.js | Microsoft Docs
description: Aprenda a desarrollar e implementar aplicaciones de Node.js en la nube con Azure.
ms.topic: hub-page
...
ms.locfileid: "48981779"
---
<div id="main" class="v2">
    <div class="container">
        <h1 style="text-align: center">Centro de desarrollo de Windows</h1> 
        <p style="text-align: center">Cree, implemente y escale sus aplicaciones de Node.js en la nube de Azure.</p>
